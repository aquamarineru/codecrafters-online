export default function Circle() {
    ...
    return(
        <div className="hidden md:block from-white-5 to-white-10 max-w-[calc(100%-2rem)] rounded-xl border-[2px] border-light border-opacity-5 bg-opacity-40 bg-glass md:px-4 md:py-4 mx-auto ml-0 md:-mb-32 w-full ">
