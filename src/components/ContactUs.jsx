            ...
            Array.isArray(contactData) && contactData.length > 0 && contactData.map((item, index) => {
                ...
                return (
                    <div className='flex flex-col justify-center items-center w-full h-screen md:h-full z-0' key={item._id}>
                        ...
                        <div className='absolute top-1/2 left-1/2 xl:top-1/2 lg:left-2/3 transform -translate-x-1/2 -translate-y-1/2 z-10 bg-dark/80 p-4 w-[250px] md:w-[350px] xl:px-24 xl:py-24 rounded'>
